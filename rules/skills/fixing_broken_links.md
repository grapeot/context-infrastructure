...
- **适用场景**: Crawl all links in a file or project, test each for a valid HTTP response, report broken ones, and fix or remove them.
- **上游来源**: [fixing-broken-links](https://github.com/spencerpauly/awesome-cursor-skills/tree/main/resources/fixing-broken-links)
- **user-invocable**: true
- **导入日期**: 2026-06-26
