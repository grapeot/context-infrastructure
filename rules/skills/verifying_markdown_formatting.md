...
- **类型**: Workflow
- **分类**: Code Quality & Security
- **适用场景**: Verify that a Markdown file has correct formatting — headings, lists, links, code blocks, spacing, and consistent style.
- **上游来源**: [verifying-markdown-formatting](https://github.com/spencerpauly/awesome-cursor-skills/tree/main/resources/verifying-markdown-formatting)
- **user-invocable**: true
- **导入日期**: 2026-06-26
