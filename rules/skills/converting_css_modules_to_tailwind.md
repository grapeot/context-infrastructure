...
- **类型**: Workflow
- **分类**: Frontend & UI
- **适用场景**: Migrate CSS Modules (.module.css/.module.scss) to Tailwind utility classes. Handles styles object removal, className interpolation, composition, and global overrides.
- **上游来源**: [converting-css-modules-to-tailwind](https://github.com/spencerpauly/awesome-cursor-skills/tree/main/resources/converting-css-modules-to-tailwind)
- **user-invocable**: true
- **导入日期**: 2026-06-26
