...
- **类型**: Workflow
- **分类**: Utilities
- **适用场景**: Write marketing copy for landing pages, product descriptions, CTAs, emails, and app UI text.
- **上游来源**: [writing-copy](https://github.com/spencerpauly/awesome-cursor-skills/tree/main/resources/writing-copy)
- **user-invocable**: true
- **导入日期**: 2026-06-26
