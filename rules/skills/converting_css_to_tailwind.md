...
- **类型**: Workflow
- **分类**: Frontend & UI
- **适用场景**: Convert plain CSS stylesheets to Tailwind CSS utility classes. Handles selectors, media queries, pseudo-classes, custom properties, and animations.
- **上游来源**: [converting-css-to-tailwind](https://github.com/spencerpauly/awesome-cursor-skills/tree/main/resources/converting-css-to-tailwind)
- **user-invocable**: true
- **导入日期**: 2026-06-26
