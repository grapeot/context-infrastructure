...
- **类型**: Workflow
- **分类**: Frontend & UI
- **适用场景**: Enforce a configuration-driven design system when generating UI. Ensures consistent spacing, colors, typography, dark mode, interactions, and accessibility across all AI-generated components.
- **上游来源**: [using-ui-stack](https://github.com/spencerpauly/awesome-cursor-skills/tree/main/resources/using-ui-stack)
- **user-invocable**: true
- **导入日期**: 2026-06-26
