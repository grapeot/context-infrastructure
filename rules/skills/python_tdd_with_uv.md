...
- **类型**: Workflow
- **分类**: Testing
- **适用场景**: Test-driven development in Python using uv as the package manager. Covers the red-green-refactor cycle, vertical slicing, and uv project setup.
- **上游来源**: [python-tdd-with-uv](https://github.com/spencerpauly/awesome-cursor-skills/tree/main/resources/python-tdd-with-uv)
- **user-invocable**: true
- **导入日期**: 2026-06-26
