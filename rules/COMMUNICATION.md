...
反例：「所以 skill 必须 personalized。到了团队场景，这件事变成麻烦。」两句之间没有承接，像两块砖。  
改写：「所以 skill 必须 personalized，这条没得商量。但到了团队场景，这件事马上变成麻烦。」「这条没得商量」是半虚的承接，强化语气、接住上半句；「但」「马上」做转折和急迫感。

另一个反例：「加载由每个人的 INDEX 文件控制。」典型英文直译（"Loading is controlled by each person's INDEX file"），主语是抽象动作名词。  
